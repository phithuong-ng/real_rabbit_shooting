...
class Game: 
    ...
    def load_assets(self): 
        ...
        self.player_frames = import_folder(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\player')  # Updated path 
        self.bullet_surf = import_image(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\gun', 'bullet')  # Updated path 
        self.fire_surf = import_image(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\gun', 'fire')  # Updated path 
        self.bee_frames = import_folder(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\enemies\bee')  # Updated path 
        self.worm_frames = import_folder(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\enemies\worm')  # Updated path 
    ...
    def show_menu(self):
        ...
        menu_background = pygame.image.load(r'C:\Users\Swift3\Desktop\real_rabbit_shooting\images\background\purplebackground.png').convert()
        menu_background = pygame.transform.scale(menu_background, (WINDOW_WIDTH, WINDOW_HEIGHT))

        while menu_active:
            # Draw the menu background
            self.display_surface.blit(menu_background, (0, 0))
